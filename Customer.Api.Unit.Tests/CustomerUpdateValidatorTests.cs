...
public class CustomerUpdateValidatorTests
{
    ...
    public async Task Should_Error_When_Name_Is_Null_Or_Empty(string name)
    {
        ...
        // Act
        var result = await validator.TestValidateAsync(customerUpdateModel);
    ...
    public async Task Should_Error_When_Age_Is_Invalid(int age)
    {
        ...
        var customerUpdateModelModel = new CustomerUpdateModel()
        {
            Name = "some name",
        ...
        // Act
        var result = await validator.TestValidateAsync(customerUpdateModelModel);
